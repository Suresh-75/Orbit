...
function AboutUs() {
  return (
    <div className="flex flex-col items-center justify-start px-20 max-sm:px-10">
      ...
      <p className="text-3xl max-sm:text-xl max-sm:leading-5 max-sm:mx-0 max-sm:m-0 max-sm:p-0  text-center mx-10 mt-5 tracking-wide leading-12 max-lg:text-xl max-lg:leading-8">
